...
def calculate_mentions(abstracts, brain_regions):
    ...
    brain_region_counts = brain_region_counts/brain_region_counts.max()
    ...
    co_mentions = co_mentions/co_mentions.max().max()
    print('Number of mentions and co-mentions was calculated.')
    return brain_region_counts, co_mentions
...
print('data loaded.')
counts, co_mentions = calculate_mentions(abstracts, brain_regions)
plot_network(counts, co_mentions)
